...
export const toolConfigs: Record<string, ToolConfig> = {
  ...
  organiser: { accept: '.pdf', multiple: false, available: true,
    options: [{ type: 'text', key: 'order', label: 'Ordre des pages', placeholder: 'Ex: 3,1,2,5,4' }]
  },
  ...
  censurer: {
    accept: '.pdf', multiple: false, available: true,
    options: [
      { type: 'text', key: 'searchText', label: 'Texte à censurer', placeholder: 'Texte sensible', required: true }
    ]
  },
  proteger: {
    accept: '.pdf', multiple: false, available: true,
